...
BLOG_AUTHOR = "Amir Sadoughi"  # (translatable)
BLOG_TITLE = "Amir Sadoughi"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://blog.princehonest.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://blog.princehonest.com/"
BLOG_EMAIL = "me@princehonest.com"
BLOG_DESCRIPTION = "Amir Sadoughi's thoughts and ideas."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://fb.com/amir.sadoughi', 'My Facebook', 'icon-facebook'),
